...
def predict():
    ...
    cv = pickle.load(open("deployed_SVM_ratings_vectorizer.pickle", "rb"))
    tf_idf_transformer = pickle.load(open("deployed_SVM_ratings_transformer.pickle", "rb"))

    # Load saved MinMax scaler for fitted for the plot length feature
    scaler = "deployed_SVM_ratings_scaler.sav"
    ...
    classifer = "deployed_SVM_ratings_classifier.sav"
